  ...
  return (
    <section id="home" className="pt-[108px] md:pt-[116px]">
      <div className="relative w-full overflow-hidden min-h-[78vh] md:min-h-[88vh]">
        ...
        <div className="relative z-10 min-h-[78vh] md:min-h-[88vh] flex flex-col items-center justify-center text-center px-5 md:px-8 lg:px-12">
          <div key={index} className="animate-fade-slide max-w-3xl">
            <p className="text-soft-300 text-sm md:text-base tracking-[0.2em] uppercase font-semibold mb-4">
              {SALON.subtitle}
            </p>
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl text-white leading-[1.08] drop-shadow-sm">
              {slide.title}
            </h1>
            <p className="mt-5 text-white/90 text-base md:text-xl max-w-xl mx-auto">{slide.text}</p>
          ...
          <div className="absolute bottom-8 inset-x-0 px-5 md:px-8 lg:px-12 flex items-center justify-between">
      ...
      <div className="bg-soft-500 text-white">
        <div className="px-5 md:px-8 lg:px-12 py-5 md:py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
